...
export const courses = [
  [
    ...
    'Product, security and compliance teams',
    'Product scope, classification and relevant exclusions.',
    'Classify products under CRA scope.',
  ],
  [
    'Essential requirements',
    'Embedded and platform engineers',
    'Secure design, updates, access control and engineering evidence.',
    'Map Annex I evidence requirements.',
  ],
  [
    'Product risk assessment',
    'Security engineers and programme managers',
    'Threat modelling, risk documentation and support planning.',
    'Document an Article 13 assessment.',
  ],
  [
    'Vulnerability handling',
    'Product security and PSIRT teams',
    'SBOM, VEX, CSAF and disclosure policy.',
    'Build SBOM, VEX and CSAF outputs.',
  ],
  [
    'Reporting and response',
    'PSIRT and compliance teams',
    'Reporting responsibilities and an incident tabletop.',
    'Run an Article 14 reporting exercise.',
  ],
  [
    'Conformity and supplier evidence',
    'Quality, compliance and supplier teams',
    'Technical files, supplier clauses and neighbouring standards.',
    'Organize evidence and a product gap assessment.',
  ],
];
